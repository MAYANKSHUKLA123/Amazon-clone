    ...
    return (
        ...
        <div className="login">
            ...
            <div className="login_container">
                ...
                <p>
                    By signing-in you agree to AMAZON Condition of Use and Sale.
